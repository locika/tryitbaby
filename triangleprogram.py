...
def triangle(a,b,c):
    """
    Here comes your part :D
    The Unit test waits for theese strings as output:
    "The T(erritory) of the triangle is: "x" 
...
if __name__ == '__main__':
    a=b=c=1#Change 1 to number what you want to test
    triangle(a,b,c)
